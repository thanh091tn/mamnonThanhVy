...
export function mapStudentClassHistoryRow(row) {
  return {
    ...
    fromAcademicYearId: row.from_academic_year_id != null ? Number(row.from_academic_year_id) : null,
    toAcademicYearId: row.to_academic_year_id != null ? Number(row.to_academic_year_id) : null,
